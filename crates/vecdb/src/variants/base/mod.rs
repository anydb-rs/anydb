...
use crate::{Error, Result, Stamp, VecIndex, VecValue, Version};
    ...
    T: VecValue,
{
    ...
    #[inline]
    pub fn set_saved_stamped_changes(&mut self, val: u16) {
    ...
    /// Returns the stamp from the header
